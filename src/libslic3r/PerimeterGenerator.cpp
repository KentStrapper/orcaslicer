...
{
    // Wave overhangs are 100% opt-in: all wave code paths below are guarded by use_wave_overhangs.
    // When wave_overhangs = false (the default), this function behaves identically to upstream.
