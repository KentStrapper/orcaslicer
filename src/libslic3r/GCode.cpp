// Orca: wave-overhang port version (bumped on algorithm-breaking changes).
#ifndef WAVE_OVERHANGS_VERSION
#define WAVE_OVERHANGS_VERSION "0.3.0"
#endif
// Orca: base version string for wave-overhang debug markers.
#ifndef SoftFever_VERSION
#define SoftFever_VERSION "2.3.2"
#endif
