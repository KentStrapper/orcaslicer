...
void PrintConfigDef::init_fff_params()
{
    ...
    */
    ...
    def = this->add("hole_wall_loops", coInt);
    def->label = L("Hole wall loops");
    def->category = L("Strength");
    def->tooltip = L("Number of walls around internal holes and voids. "
                     "Set to 0 to use the same value as Wall loops. "
                     "Use a lower value to achieve tighter hole tolerances without "
                     "reducing external wall strength. Useful for threaded holes, "
                     "heat-set insert seats, and precision bore fits.");
