...
void PrintConfigDef::init_fff_params()
{
    ...
    */
    ...
    def->tooltip = L("Termination threshold for Andersons propagation: when a new wavefront adds less "
                     ...
                     "termination. Our default 0.01 mm\xc2\xb2 is a safer early-stop than Andersons' "
                     "research-code value of 1e-4 mm\xc2\xb2; lower toward 0.0001 for maximum coverage.");
    def->sidetext = L("mm\xc2\xb2");
    def->mode = comDevelop;
    def->min = 0.0;
    def->max = 100.0;
