...
void GLGizmoFdmSupports::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    for (int i = 0; i < tool_ids.size(); i++) {
        ...
        if (m_current_tool == tool_ids[i]) {
            ImGui::PushStyleColor(ImGuiCol_Button,          ImVec4(1.0f, 0.53f, 0.0f, 0.25f));  // Kentstrapper orange for selected tool / brush
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered,   ImVec4(1.0f, 0.53f, 0.0f, 0.25f));  // Kentstrapper orange for selected tool / brush
            ImGui::PushStyleColor(ImGuiCol_ButtonActive,    ImVec4(1.0f, 0.53f, 0.0f, 0.30f));  // Kentstrapper orange for selected tool / brush
            ImGui::PushStyleColor(ImGuiCol_Border,          ImVec4(1.0f, 0.53f, 0.0f, 1.0f));   // Kentstrapper orange border on selected tool / brush
