...
/*#ifdef __WXOSX__
    ...
    StateColor box_border_colour(std::pair<wxColour, int>(wxColour("#FF8800"), StateColor::Normal)); // ORCA match border color with other input/combo boxes
...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Strength"), "custom-gcode_strength"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("hole_wall_loops");
