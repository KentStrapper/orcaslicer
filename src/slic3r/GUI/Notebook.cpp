...
void ButtonsListCtrl::OnPaint(wxPaintEvent&)
{
    ...
    // Kentstrapper: orange selected tab
...
void ButtonsListCtrl::SetSelection(int sel)
{
    ...
    // Kentstrapper: orange accent replaces teal
    wxColour selected_btn_bg("#FF8800");
    if (m_selection >= 0) {
    ...
    // Kentstrapper: selected tab = orange, hover = darker orange
    StateColor bg_color = StateColor(
        std::pair{wxColour(204, 110, 0), (int) StateColor::Hovered},
