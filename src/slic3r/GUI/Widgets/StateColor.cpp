...
static std::map<wxColour, wxColour> gDarkColors{
    {"#FF8800", "#CC6E00"}, // rgb(255, 136, 0)    Kentstrapper orange accent
    ...
    {"#CC6E00", "#995200"}, // rgb(204, 110, 0)    Kentstrapper orange hover
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#FFE0B2", "#3C2800"}, // rgb(255, 224, 178)  Dropdown checked item background color > Kentstrapper orange with 25% opacity
    {"#FFF3E0", "#2D1A00"}, // rgb(255, 243, 224)  Combo / Dropdown focused background color > Kentstrapper orange with 10% opacity
};
