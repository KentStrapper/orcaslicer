    ...
    , state_handler(this)
{
    ...
    // Kentstrapper: orange accent replaces teal (#009688 → #FF8800, hover #26A69A → #CC6E00)
    border_color.append(0x6B6B6B, StateColor::Disabled);
    border_color.append(wxColour(180, 90, 0), StateColor::Pressed);
    border_color.append(wxColour(204, 110, 0), StateColor::Hovered);
    border_color.append(0xFF8800, StateColor::Normal);
    ...
    background_color.append(wxColour(180, 90, 0), StateColor::Pressed);
    background_color.append(wxColour(204, 110, 0), StateColor::Hovered);
    background_color.append(0xFF8800, StateColor::Normal);
